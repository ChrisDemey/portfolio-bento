<template>
  <div
    class="group relative bg-light/10 shadow-[#5EEAD4]/30 hover:shadow-lg backdrop-blur-2xl rounded-2xl size-full overflow-hidden text-light-gray transition-shadow"
  >
    <div
